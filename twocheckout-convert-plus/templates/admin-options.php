...
<p><?php _e( '2Checkout - Credit Card by Convert Plus Checkout', 'woocommerce' ); ?></p>
    ...
    <tr valign="top">
        ...
        <td class="forminp">
            <fieldset>
                ...
                <input class="input-text regular-input" type="text" value="<?php echo add_query_arg( 'wc-api', '2checkout_ipn_convert_plus', home_url( '/' ) ); ?>" readonly>
